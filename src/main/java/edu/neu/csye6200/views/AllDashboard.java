...
//            System.err.println(k + " is about to deleted : " + row);
            ...
            JOptionPane.showMessageDialog(this, c.getTime().toString(), " Next Immunization date(Dose 2)", JOptionPane.ERROR_MESSAGE);
                //JOptionPane.showMessageDialog(this, "StudentClass is to be vaccinated", "Vaccine1 dose 2 missing alert", JOptionPane.ERROR_MESSAGE);
            ...
            JOptionPane.showMessageDialog(this, c.getTime().toString(), " Next Immunization date(Vaccine 2)", JOptionPane.ERROR_MESSAGE);
                //JOptionPane.showMessageDialog(this, "StudentClass is to be vaccinated", "Vaccine2 missing alert", JOptionPane.ERROR_MESSAGE);
            }
//            Calendar c = Calendar.getInstance();
//            c.setTime(date);
//            c.add(Calendar.YEAR, 1);
...
//            int counter = 0;
//            try {
//                for (ClassroomClass classroom : allClassRooms) {
//                    int tempCounter = 0;
